...
const EMAILJS_SERVICE_ID = "service_furnk9w";
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-center gap-8 pt-8 border-t border-border mt-8">
              <div className="text-center">
                <a href="https://www.instagram.com/retoucherirving" target="_blank" rel="noopener noreferrer" className="inline-flex flex-col items-center gap-2 p-3 rounded-lg hover:bg-accent/20 transition-all duration-300 group">
                  <svg className="w-8 h-8 text-accent group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center">
                <a href="https://www.facebook.com/retoucherirving1" target="_blank" rel="noopener noreferrer" className="inline-flex flex-col items-center gap-2 p-3 rounded-lg hover:bg-accent/20 transition-all duration-300 group">
                  <svg className="w-8 h-8 text-accent group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
